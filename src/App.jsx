                            ...
                            >
                                {faq.map(el => (
                                    <Accordion key={el.question}>
                                        <AccordionSummary expandIcon={<CaretDown size={23} />}>
                                            <Typography fontSize={16} fontWeight={500}>{el.question}</Typography>
                                        </AccordionSummary>

                                        <AccordionDetails sx={{ fontSize: 18 }}>
                                            <Stack gap={1}>
                                                {el.answer.map(text => <Typography>{text}</Typography>)}
                                            </Stack>
                                        </AccordionDetails>
                                    </Accordion>
                                ))}
